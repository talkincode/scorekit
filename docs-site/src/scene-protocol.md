...
produce at most 65,536 note/control events per scene or section, including
samples generated by linear automation; validation rejects larger expansions
before composition allocates them.
